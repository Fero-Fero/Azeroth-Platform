...
/// <summary>
/// How the launcher treats a manifest file. Mirrors the backend contract.
/// </summary>
public enum ManifestFileGroup
{
    ...
    /// <summary>Managed file (patches/config); always hash-verified and pruned when removed server-side.</summary>
    Managed = 1
}
