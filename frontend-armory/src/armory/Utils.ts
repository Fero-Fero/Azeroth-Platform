...
export interface IEmblemSource {
	background: number;
	emblemStyle: number;
	emblemColor: number;
	borderStyle: number;
...
export class Utils {
	public static raceNames: { [key: number]: string } = {
		1: "human",
		2: "orc",
		3: "dwarf",
		4: "nightelf",
	...
	public static classNames: { [key: number]: string } = {
		1: "warrior",
		2: "paladin",
		3: "hunter",
		4: "rogue",
	...
	public static makeEmblemObject(obj: IEmblemSource, padWithZeroes = true): IEmblem {
