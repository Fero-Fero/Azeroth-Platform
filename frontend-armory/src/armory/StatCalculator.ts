 ...
 *
 * Talent, aura, set-bonus and glyph effects are out of scope, so values can differ
 * from the in-game character sheet. Health and Mana are read directly from the DB
 * and are accurate.
 */
