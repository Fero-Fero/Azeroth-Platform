...
public sealed class MigrationOptions
{
    ...
    /// <summary>
    /// Unused: nothing reads this, and a module install session always deletes its scratch. Kept so
    /// existing appsettings keys continue to bind. Setting it does not retain anything.
    /// </summary>
    public bool KeepModuleInstallTemp { get; set; }

    /// <summary>
    /// Unused: DBC CSVs are converted on demand from the stack data directory. Kept so existing
    /// appsettings/test keys continue to bind.
    /// </summary>
    public bool DbcStoreAutoSyncOnStart { get; set; }
