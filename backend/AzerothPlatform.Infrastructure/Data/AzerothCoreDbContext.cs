...
public class AzerothCoreDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ManagedStackEntity>(entity =>
        {
            ...
            entity.Property(stack => stack.ModuleBranchesJson).IsRequired();
            entity.Property(stack => stack.ModuleCheckFingerprint).IsRequired();
            entity.Property(stack => stack.ModuleCheckJson).IsRequired();
            ...
            entity.Property(stack => stack.ExpressProvisionPhase).HasConversion<string>().HasMaxLength(32).IsRequired();
