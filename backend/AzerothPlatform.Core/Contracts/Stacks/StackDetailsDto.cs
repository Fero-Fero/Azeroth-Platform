...
public class StackDetailsDto
{
    ...
    public ExpressProvisionPhase ExpressProvisionPhase { get; set; }

    /// <summary>
    /// True after Express created the game account <c>admin</c> / <c>admin</c> (GM 3).
    ...
    /// <summary>Last per-module compile gate (null if a check has not been run).</summary>
    public ModuleCheckStatusDto? ModuleCheck { get; set; }
}
