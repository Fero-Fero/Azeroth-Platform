...
/// <summary>A stored point-in-time snapshot of a stack's databases + configuration.</summary>
public sealed class RevisionDto
{
    ...
    /// <summary>Core commit SHA at snapshot time (informational; restoring code needs a rebuild).</summary>
