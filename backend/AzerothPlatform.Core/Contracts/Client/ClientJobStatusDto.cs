...
public class ClientJobStatusDto
{
    ...
    /// <summary>Bytes processed in the current extract/copy phase, when known.</summary>
    public long? BytesCompleted { get; set; }

    /// <summary>Total bytes for the current phase. Null when the total is not known yet (extract).</summary>
...
/// <summary>Request to download a base client from a direct HTTP(S) URL (archive or public Drive share).</summary>
public sealed class DownloadBaseClientRequestDto
{
