...
public class ModuleDto
{
    ...
    /// <summary>
    /// Compile/checkout recipe copied from the module's install hook. Empty for
    /// custom catalog modules and for built-ins that only need a git clone.
    /// </summary>
    public ModuleCompileProfile Compile { get; set; } = ModuleCompileProfile.Empty;
}
