...
///
/// The player-facing launcher path (profiles, login, config, manifest, files, branding) and game-client
/// distribution do not belong here — each stack's own client-server container serves those directly, and
/// the manager stays out of the player path.
/// </summary>
[ApiController]
