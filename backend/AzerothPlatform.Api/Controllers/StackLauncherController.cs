...
/// the Config.wtf template editor. The player download path (config/manifest/files) is served by each
/// stack's own client-server container, so it no longer lives here.
/// </summary>
[ApiController]
