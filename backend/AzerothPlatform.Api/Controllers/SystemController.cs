...
using AzerothPlatform.Core.Networking;
...
public class SystemController : ControllerBase
{
    ...
    /// <summary>
    /// Anonymous marker used by the localhost UI to discover this manager's LAN address. Emits its own
    /// permissive CORS header because the probe runs cross-origin: a http://localhost:{port} page trying
    /// http://192.168.x.y:{port} candidates.
    /// </summary>
    [AllowAnonymous]
    [HttpGet("lan-probe")]
