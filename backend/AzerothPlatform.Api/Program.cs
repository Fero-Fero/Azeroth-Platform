...
try
{
    ...
    AzerothPlatform.Infrastructure.Services.Patches.MigrationTelemetry.RegisterLoggingListener(
    ...
    await using (var scope = app.Services.CreateAsyncScope())
    {
        ...
        var expressProvision = scope.ServiceProvider.GetRequiredService<IExpressProvisionService>();
        expressProvision.ResumeInterrupted();
        Log.Information("Interrupted Express Setup recovery completed");
