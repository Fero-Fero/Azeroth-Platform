...
namespace WDBXEditor
{
    static class Program
    {
        ...
        {
            // Console (CLI) mode: dispatch BEFORE any WinForms/GDI+ init (EnableVisualStyles touches
            // XplatUI, which requires an X server). This lets the -import/-export CLI run headless
            // under Mono on Linux, which the Azeroth Platform's DBC pipeline relies on.
