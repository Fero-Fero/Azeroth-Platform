  ...
  return (
    <div className="space-y-6">
      ...
      <FormField
        ...
        hint="0–2500. Written to playerbots.conf (10 bots per account; account count is set automatically)."
        required
      >
        <input
          id="randomBotCount"
      ...
      <p className="text-sm text-gray-600">
        {count === 0
          ...
          : `${count} random bots will autologin on the real start (${Math.ceil(count / 10)} accounts at 10 bots each).`}
      </p>
    </div>
  )
}
