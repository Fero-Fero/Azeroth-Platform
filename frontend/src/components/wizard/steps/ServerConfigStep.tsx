              ...
              <button
                ...
                onClick={() => {
                  ...
                  if (id === ServerType.Express) {
                    ...
                    setValue('includeArmory', false, { shouldDirty: true, shouldValidate: true })
                    applyExpressLocalDefaults(setValue, watch)
                  } else {
                    setValue('includeArmory', true, { shouldDirty: true, shouldValidate: true })
                    setValue(
                      'moduleIds',
        ...
        <span>
          ...
          <span className="mt-0.5 block text-xs text-gray-500">
            {serverType === ServerType.Express
              ? 'Off for Express Setup unless you turn it on. The launcher still downloads client files from this stack.'
              : 'When off, this stack never builds or starts the armory. The launcher still downloads client files from this stack.'}
          </span>
        </span>
      </label>
    </div>
