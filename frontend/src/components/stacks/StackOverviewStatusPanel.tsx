...
export default function StackOverviewStatusPanel({
  ...
  const launcherBuilding = launcherBuild?.isBuilding
  const launcherNotBuilt = launcherBuild && !launcherBuild.downloadAvailable && !launcherBuilding

  const hasUpdates = stack.updateStatus?.hasUpdates
