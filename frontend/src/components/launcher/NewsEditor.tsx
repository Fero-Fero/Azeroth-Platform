...
import { StackTabHeader, StackTabSideCard } from '@/components/stacks/StackTabChrome'
import { NEWS_ARTICLE_TEMPLATES, type NewsArticleTemplate } from '@/lib/news-templates'
import {
